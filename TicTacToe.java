...
public class TicTacToe {
    ...
    private void winningGame(){
        ...
        // for player o
            ...
            JOptionPane.showMessageDialog(frame,"Player No one wins","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void initialize() {
        ...
        btnExit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(JOptionPane.showConfirmDialog(frame, "Confirm you want too exit","Tic Tac Toe",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION)
                {
                    System.exit(0);
                }
            }
